    ...
    <div className="relative z-10 -mt-10 rounded-t-[40px] bg-white pb-24 pt-16 shadow-[0_-25px_60px_-20px_rgba(0,0,0,0.25)] sm:pb-28 sm:pt-20">
      <section className="mx-auto w-full max-w-6xl px-6">
        <div className="flex flex-col items-center text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#C80000]">
            Fale com a gente
          </p>
          <BlurText
          ...
          <p className="mt-4 max-w-md text-sm text-neutral-500">
            Conte como imagina o seu ambiente. Sua mensagem vai direto para o nosso WhatsApp.
          </p>
        </div>
          ...
          <div className="rounded-[46px] bg-neutral-900 p-3 shadow-[0_35px_70px_-25px_rgba(0,0,0,0.5)]">
            <div className="relative overflow-hidden rounded-[34px] bg-[#f2f2f5]">
              ...
              <div className="flex items-center gap-3 border-b border-black/5 bg-white/80 px-5 py-3 backdrop-blur">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-black p-1.5">
                  <img src={logo} alt="Almeida" className="h-full w-full object-contain" draggable={false} />
                </div>
                <div className="text-left">
                  <p className="text-sm font-semibold text-neutral-900">Almeida Móveis Planejados</p>
              ...
              <div className="flex min-h-[230px] flex-col gap-3 px-4 py-5">
                <div className="max-w-[82%] rounded-2xl rounded-tl-sm bg-white px-4 py-2.5 text-left text-[14px] leading-snug text-neutral-800 shadow-sm">
                  Oi! 👋 Conte pra gente como você imagina o ambiente dos seus sonhos.
                </div>

                {sent && message && (
                  <div className="ml-auto max-w-[82%] rounded-2xl rounded-tr-sm bg-[#C80000] px-4 py-2.5 text-left text-[14px] leading-snug text-white shadow-sm">
                    {message}
                  </div>
                )}
              </div>
              ...
              <div className="flex items-end gap-2 border-t border-black/5 bg-white/90 px-3 py-3 backdrop-blur">
                ...
                <button
                  ...
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#C80000] text-white shadow-md transition active:scale-95 disabled:opacity-30"
                >
