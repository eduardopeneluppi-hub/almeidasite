...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    quote:
      'A equipe entendeu exatamente como a gente vive na cozinha. Hoje ela é o cômodo que mais usamos em casa, e cada gaveta tem seu lugar certo.',
  },
  {
    name: 'Carlos Menezes',
    ...
    rating: 5,
    quote:
      'Eu não acreditava que daria pra aproveitar tão bem aquele espaço pequeno. A Almeida projetou um closet que parece de loja, e o acabamento é impecável.',
  },
  {
    name: 'Juliana Prado',
    role: 'Quarto do casal',
    avatar: 'https://i.pravatar.cc/150?img=32',
    rating: 5,
    quote:
      'Do primeiro papo até a instalação, foi tudo muito transparente. O quarto ficou aconchegante e sofisticado ao mesmo tempo, exatamente o que pedimos.',
  },
  {
    name: 'Marcos Tavares',
    role: 'Sala de estar',
    ...
    rating: 5,
    quote:
      'Prazo cumprido, montagem cuidadosa e um resultado que valorizou muito o apartamento. Recomendo de olhos fechados pra quem quer qualidade de verdade.',
  },
  {
    name: 'Beatriz Lima',
    role: 'Adega e living bar',
    avatar: 'https://i.pravatar.cc/150?img=44',
    rating: 5,
    quote:
      'Sempre quis um cantinho para receber os amigos e a Almeida entregou muito mais do que eu imaginava. Todo mundo que visita pergunta quem fez.',
  },
  {
    name: 'Rafael Souza',
    role: 'Projeto completo do apê',
    avatar: 'https://i.pravatar.cc/150?img=8',
    rating: 5,
    quote:
      'Fechamos o apartamento inteiro com eles. Atendimento próximo, projeto 3D antes de começar e móveis que combinam entre si em cada ambiente.',
  },
]
  ...
  <div className="flex gap-1" aria-label={`${count} de 5 estrelas`}>
    {Array.from({ length: 5 }).map((_, i) => (
      <svg
        key={i}
        viewBox="0 0 20 20"
        className={`h-4 w-4 ${i < count ? 'fill-[#C80000]' : 'fill-black/10'}`}
      >
    ...
    <section className="relative z-10 mx-auto w-full max-w-6xl px-6 py-20 sm:py-28">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mb-5 mt-3 text-sm font-semibold uppercase tracking-[0.2em] text-white/80">
          Famílias que confiaram na Almeida
        </p>
            ...
            >
              ...
              <div className="mt-8 flex items-center gap-3 border-t border-black/5 pt-5">
                <img
                  src={t.avatar}
                  alt={t.name}
                  className="h-11 w-11 rounded-full object-cover ring-2 ring-[#C80000]/15"
                  draggable={false}
                />
