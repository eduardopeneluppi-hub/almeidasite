...
export default function QuoteModal() {
  ...
  const handleSend = () => {
    if (!canSend) return
    const parts = []
    if (selected.length) parts.push(`Ambiente(s) de interesse: ${selected.join(', ')}.`)
  ...
  return (
    <>
      <motion.button
        ...
        whileTap={{ scale: 0.96 }}
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full bg-[#C80000] px-5 py-3.5 text-sm font-semibold text-white shadow-[0_10px_30px_-8px_rgba(200,0,0,0.6)]"
      >
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C80000]">
                Vamos conversar
              </p>
              <BlurText
              ...
              <p className="mt-3 text-sm text-neutral-500">
                Selecione o ambiente que você quer planejar. Pode marcar mais de um.
              </p>
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-full border px-4 py-2 text-sm font-medium transition ${
                        isSelected
                          ? 'border-[#C80000] bg-[#C80000] text-white shadow-sm'
                          : 'border-neutral-200 bg-white text-neutral-700 hover:border-[#C80000]/40 hover:text-[#C80000]'
                      }`}
                    >
                      {room}
                    </button>
              ...
              <textarea
                ...
                placeholder="Não encontrou o ambiente? Descreva aqui o que você precisa..."
                rows={3}
                className="mt-5 w-full resize-none rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm text-neutral-800 outline-none placeholder:text-neutral-400 focus:border-[#C80000]/40 focus:bg-white"
              />
